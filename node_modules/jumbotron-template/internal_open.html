...
<head>
    <title>Jumbotron - Beautiful Marketing Template</title>
...
<body>
    ...
    <header id="header">
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <a class="navbar-brand" href="#" id="header-logo">
                <img src="img/annatalogo.png" class="img-fluid" width="100"
                    >
            </a>
    ...
    <main id="main" role="main">
        <div class="jumbotron my-5 cust-header">
            <div class="container ">
              
                <img src="img/annata.PNG" >
...
<div class="container my-5">
    <div class="row text-center cust-home-header-text">
        <p><h2>Internal Open </h2></p>
    </div>    
    <div class="row text-center py-5">
        <div class="col-md-4">
            <div class="card" style="width:300px">
                <img class="card-img-top" src="img/training.png" alt="Card image">
                <div class="card-body">
                  <h4 class="card-title">Internal Training</h4>
                  <p class="card-text">Training for Annata Employee's</p>
                  <a href="internal_about.html" class="btn btn-info">About</a>
                  <a href="internal_open.html" class="btn btn-danger">Open</a>
                </div>
              </div>
        ...
        <div class="col-md-4">
            <div class="card" style="width:300px">
                <img class="card-img-top" src="img/training.png" alt="Card image">
                <div class="card-body">
                  <h4 class="card-title">Partner Training</h4>
                  <p class="card-text">Training for Annata Partner's</p>
                  <a href="partner_about.html" class="btn btn-info">About</a>
                  <a href="partner_open.html" class="btn btn-danger">Open</a>
                </div>
              </div>
        ...
        <div class="col-md-4">
            <div class="card" style="width:300px">
                <img class="card-img-top" src="img/training.png" alt="Card image">
                <div class="card-body">
                  <h4 class="card-title">Customer Training</h4>
                  <p class="card-text">Training for Annata Customer's</p>
                  <a href="customer_about.html" class="btn btn-info">About</a>
                  <a href="customer_open.html" class="btn btn-danger">Open</a>
                </div>
              </div>
